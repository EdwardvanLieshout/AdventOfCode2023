    ...
    map.forEach((line) => {
        ...
        seedRanges.forEach((seedRange, index) => {
            ...
            if (seedRange[0] >= +vals[1] && seedRange[0] + seedRange[1] <= +vals[1] + +vals[2]) {
                console.log('within', +vals[0], seedRange[0], +vals[1])
            ...
            if (
                ...
                console.log('right', +vals[0], seedRange[0], +vals[1], seedRange[1])
            ...
            if (
                ...
                console.log('left', +vals[0], seedRange[0], +vals[1])
                const start = +vals[1]
            ...
            if (
                ...
                console.log('around', +vals[0], seedRange[0], +vals[1])
                const start = +vals[1]
                const end = +vals[1] + +vals[2]
                const begin = seedRange[0]
                const final = seedRange[0] + seedRange[1]
